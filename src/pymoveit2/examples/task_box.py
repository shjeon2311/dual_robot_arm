...
def main():
    ...
    pos_1 = [[0.205, 0.16, 0.13], [0.22, 0.18, 0.1], [0.26, -0.04, 0.09], 
             [0.23, -0.08, 0.09], [0.26, -0.09, 0.27], [0.18, 0.0, 0.22], 
             [0.22, 0.01, 0.22], [0.21, 0.04, 0.2], [0.18, 0.16, 0.22], 
             [0.165, 0.13, 0.1], [0.165, -0.25, 0.1]]
    pos_2 = [[0.18, -0.15, 0.28], [0.21, -0.15, 0.055], [0.2, 0.01, 0.28], 
             [0.12, 0.06, 0.18], [0.12, -0.01, 0.18], [0.19, 0.03, 0.19],
             [0.18, 0.03, 0.15], [0.18, -0.14, 0.15]]
    quat_1 = [[0.1, 0.1, -0.7, 0.7], [0.0, 0.0, 1.0, 0.0],[-0.7, -0.7, -0.1, -0.1]]
    quat_2 = [[-0.1, -0.1, -0.7, 0.7], [-0.5, -0.5, 0.5, 0.5], [-0.7, -0.7, -0.1, -0.1]]
    cartesian = True
    ...
    moveit2_1.move_to_pose(position=pos_1[0], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    time.sleep(2)
    moveit2_1.move_to_pose(position=pos_1[1], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    time.sleep(4)
    close_gripper(nodea, publish_close)
    time.sleep(4)
    moveit2_1.move_to_pose(position=pos_1[2], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    moveit2_1.move_to_pose(position=pos_1[3], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    time.sleep(3)
    open_gripper(nodea, publish_open)
    time.sleep(4)
    moveit2_1.move_to_pose(position=pos_1[4], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    moveit2_1.move_to_pose(position=init_position, quat_xyzw=quat_1[0], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    ...
    moveit2_2.move_to_pose(position=pos_2[0], quat_xyzw=quat_2[2], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    time.sleep(1)
    moveit2_2.move_to_pose(position=pos_2[2], quat_xyzw=quat_2[2], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    time.sleep(4)
    open_gripper(nodeb, publish_open)
    time.sleep(4)
    ...
    close_gripper(nodeb, publish_close)
    time.sleep(3)
    moveit2_1.move_to_pose(position=pos_1[5], quat_xyzw=quat_1[0], cartesian=cartesian)
    time.sleep(2)
    moveit2_1.move_to_pose(position=pos_1[6], quat_xyzw=quat_1[0], cartesian=cartesian)
    time.sleep(2)
    moveit2_1.move_to_pose(position=pos_1[7], quat_xyzw=quat_1[2], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    moveit2_2.move_to_pose(position=pos_2[3], quat_xyzw=quat_2[0], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    moveit2_2.move_to_pose(position=pos_2[4], quat_xyzw=quat_2[0], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    moveit2_2.move_to_pose(position=pos_2[5], quat_xyzw=quat_2[2], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    time.sleep(4)
    moveit2_1.move_to_pose(position=pos_1[8], quat_xyzw=quat_1[0], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    moveit2_2.move_to_pose(position=pos_2[6], quat_xyzw=quat_2[2], cartesian=cartesian)
    moveit2_2.wait_until_executed()
    time.sleep(2)
    moveit2_2.move_to_pose(position=pos_2[7], quat_xyzw=quat_2[0], cartesian=cartesian)
    moveit2_2.wait_until_executed()

    # 5. Move the box aside
    moveit2_2.move_to_pose(position=init_position, quat_xyzw=quat_2[0], cartesian=cartesian)
    time.sleep(2)
    open_gripper(nodea, publish_open)
    time.sleep(4)
    open_gripper(nodeb, publish_open)
    time.sleep(4)
    moveit2_1.move_to_pose(position=pos_1[9], quat_xyzw=quat_1[1], cartesian=cartesian)
    moveit2_1.wait_until_executed()
    time.sleep(3)
    moveit2_1.move_to_pose(position=pos_1[10], quat_xyzw=quat_1[1], cartesian=cartesian)
    moveit2_1.wait_until_executed()
